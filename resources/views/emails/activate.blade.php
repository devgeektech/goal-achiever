											...
											<tr>
												<td width="700" valign="">
													<p style="font-size: 18px;color: #585858; font-weight: 300; font-family: 'Poppins', sans-serif;">
														Thanks for creating an account on Islamic Online Learning Centre. Your account is activated now. Your Name is <strong>{{$user['name'] ?? ""}}.</strong> and email is {{ $user['email'] ?? ""}}You can access your account area to view orders, change your password, and more at:<a href="{{URL::to('/student/update_profile')}}" style="color:#0096FF">Change Profile</a>
													</p>
												</td>
											</tr>
										</tbody>
